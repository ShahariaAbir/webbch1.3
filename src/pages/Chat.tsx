...
export default function Chat() {
  ...
  return (
    <div className="fixed inset-0 flex bg-gray-900">
      ...
      <div 
        className={`${
          selectedUser ? 'hidden md:flex md:w-[320px] lg:w-[400px]' : 'w-full md:w-[320px] lg:w-[400px]'
        } flex-col border-r border-gray-800 bg-gray-900/95`}
      >
      ...
      <div className={`${
        ...
        {selectedUser ? (
          <>
            <div className="p-4 border-b border-gray-800 bg-gray-900/95 flex items-center">
              <Button
                variant="ghost"
                size="icon"
              ...
              <Avatar className="h-8 w-8">
                ...
                <AvatarFallback 
                  className={`text-white bg-gradient-to-br ${getGradientForUser(selectedUser.email)}`}
                >
